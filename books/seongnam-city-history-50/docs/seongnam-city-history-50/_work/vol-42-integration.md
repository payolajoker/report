# Vol42 Integration Note: 제42권 성남의 전통 민속놀이

## Scope

- Source PDF: `books/seongnam-city-history-50/sources/seongnam-history-50-vol-42.pdf`
- Official source URL: https://www.seongnam.go.kr/city/1001112/30566/bbsView.do?idx=378649
- Pages: 120
- OCR: not used. Embedded text layer extracted with `pdftotext -layout`.
- Completed range: p.001-p.120. No deferred ranges.
- Common files intentionally untouched: `README.md`, `.gitattributes`, `index.md`, `manifest.yml`, `stats.md`, `figures.md`, `source-page-index.md`.
...
- Main topic: traditional folk games of Seongnam, especially Pangyo Ssangyong Geo-juldarigi, Seongnam Oritteul Nongak, and Imusul Jipteo Dajineun Sori.
- Best cross-volume links: Vol04 transport/markets for old place networks, Vol23 festivals/tourism, Vol24 religion/faith and ritual, Vol40 oral/community life, Vol41 if it covers local food or play culture once available.
- Strong tags: `folk-game`, `intangible-heritage`, `Seongnam Cultural Center`, `Pangyo`, `Gumi-dong`, `Imae-dong`, `Jeongwol Daeboreum`, `Nongak`, `labor-song`, `urbanization`, `restoration`.
...
- `pdfinfo` reports 120 pages, not encrypted, Adobe InDesign source.
- `pdftotext -layout` produced 120 source pages and about 160,590 characters.
- 120 local JPG page renders were created at 170 dpi.
- p.120 is almost blank in the source PDF; retained as a rendered audit page and a source marker.
- Run final link/source-marker validation after file creation.
