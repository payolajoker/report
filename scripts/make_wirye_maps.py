...
_namwirye = p(STOPS[9][0], STOPS[9][1])
m.add_line(Line([_yeoksa, _tram_sq, _namwirye], BRANCH_C, 6))
m.add_marker(CircleMarker(_namwirye,"white",22))
m.add_marker(CircleMarker(_namwirye,XFER_C,15))
...
img = m.render(zoom=16, center=[127.141, 37.467])
draw = ImageDraw.Draw(img)
bx,by = 18,18
